...
return {
    ...
    --
    -- Off by default: a tiling desktop does not need one, and an empty strip
    -- across the bottom of a fresh install would be a puzzle rather than a
    -- feature. Turn it on in the settings app.
    -- =====================================================================
    dock = {
        enabled   = false,
